...
const mint = new PublicKey("7V4UrsHjLwATeFrHXmnYMLhRyhC2ZMPHVfyk2yiR4wZa");
...
(async () => {
    try {
        ...
        console.log(`Success! Check out your TX here:  https://explorer.solana.com/tx/${completeTx}?cluster=devnet`);
        // https://explorer.solana.com/tx/5aHfmM6hZHEXXe9DGQqPeKkj2HkMBWLugErbwJNav93voEr772WP6QkiDG7iGDTZffHnPAz7cLY8evyiBMaotWBz?cluster=devnet
